  ...
  49                     ; 44 uint8_t ITC_GetCPUCC(void)
  49                     ; 45 {
  ...
  61                     ; 48   _asm("pop a");
  64  0001 84            	pop	a
  66                     ; 49   return; /* Ignore compiler warning, the returned value is in A register */
  69  0002 81            	ret	
  92                     ; 75 void ITC_DeInit(void)
  92                     ; 76 {
  93                     .text:	section	.text,new
  94  0000               _ITC_DeInit:
  98                     ; 77     ITC->ISPR1 = ITC_SPRX_RESET_VALUE;
 100  0000 35ff7f70      	mov	32624,#255
 101                     ; 78     ITC->ISPR2 = ITC_SPRX_RESET_VALUE;
 103  0004 35ff7f71      	mov	32625,#255
 104                     ; 79     ITC->ISPR3 = ITC_SPRX_RESET_VALUE;
 106  0008 35ff7f72      	mov	32626,#255
 107                     ; 80     ITC->ISPR4 = ITC_SPRX_RESET_VALUE;
 109  000c 35ff7f73      	mov	32627,#255
 110                     ; 81     ITC->ISPR5 = ITC_SPRX_RESET_VALUE;
 112  0010 35ff7f74      	mov	32628,#255
 113                     ; 82     ITC->ISPR6 = ITC_SPRX_RESET_VALUE;
 115  0014 35ff7f75      	mov	32629,#255
 116                     ; 83     ITC->ISPR7 = ITC_SPRX_RESET_VALUE;
 118  0018 35ff7f76      	mov	32630,#255
 119                     ; 84     ITC->ISPR8 = ITC_SPRX_RESET_VALUE;
 121  001c 35ff7f77      	mov	32631,#255
 122                     ; 85 }
 125  0020 81            	ret	
 150                     ; 92 uint8_t ITC_GetSoftIntStatus(void)
 150                     ; 93 {
 151                     .text:	section	.text,new
 152  0000               _ITC_GetSoftIntStatus:
 156                     ; 94     return (uint8_t)(ITC_GetCPUCC() & CPU_CC_I1I0);
 ...
 440                     ; 102 ITC_PriorityLevel_TypeDef ITC_GetSoftwarePriority(ITC_Irq_TypeDef IrqNum)
 440                     ; 103 {
 ...
 449                     ; 105     uint8_t Value = 0;
 451  0002 0f02          	clr	(OFST+0,sp)
 452                     ; 106     uint8_t Mask = 0;
 454                     ; 109     assert_param(IS_ITC_IRQ_OK((uint8_t)IrqNum));
 456  0004 a119          	cp	a,#25
 457  0006 250e          	jrult	L02
 458  0008 ae006d        	ldw	x,#109
 459  000b 89            	pushw	x
 460  000c 5f            	clrw	x
 461  000d 89            	pushw	x
 ...
 466  0016               L02:
 467                     ; 112     Mask = (uint8_t)(0x03U << (((uint8_t)IrqNum % 4U) * 2U));
 ...
 502  003a               L34:
 503                     ; 122     case ITC_IRQ_PORTB:
 503                     ; 123     case ITC_IRQ_PORTC:
 503                     ; 124     case ITC_IRQ_PORTD:
 503                     ; 125     case ITC_IRQ_PORTE:
 503                     ; 126         Value = (uint8_t)(ITC->ISPR2 & Mask); /* Read software priority */
 505  003a c67f71        	ld	a,32625
 506                     ; 127         break;
 508  003d 2017          	jp	LC001
 509  003f               L54:
 510                     ; 137     case ITC_IRQ_SPI:
 510                     ; 138     case ITC_IRQ_TIM1_OVF:
 510                     ; 139         Value = (uint8_t)(ITC->ISPR3 & Mask); /* Read software priority */
 512  003f c67f72        	ld	a,32626
 513                     ; 140         break;
 515  0042 2012          	jp	LC001
 516  0044               L74:
 517                     ; 141     case ITC_IRQ_TIM1_CAPCOM:
 517                     ; 142 #ifdef STM8S903
 517                     ; 143     case ITC_IRQ_TIM5_OVFTRI:
 517                     ; 144     case ITC_IRQ_TIM5_CAPCOM:
 517                     ; 145 #else
 517                     ; 146     case ITC_IRQ_TIM2_OVF:
 517                     ; 147     case ITC_IRQ_TIM2_CAPCOM:
 517                     ; 148 #endif /*STM8S903*/
 517                     ; 149 
 517                     ; 150     case ITC_IRQ_TIM3_OVF:
 517                     ; 151         Value = (uint8_t)(ITC->ISPR4 & Mask); /* Read software priority */
 519  0044 c67f73        	ld	a,32627
 520                     ; 152         break;
 522  0047 200d          	jp	LC001
 523  0049               L15:
 524                     ; 153     case ITC_IRQ_TIM3_CAPCOM:
 524                     ; 154     case ITC_IRQ_UART1_TX:
 524                     ; 155     case ITC_IRQ_UART1_RX:
 524                     ; 156     case ITC_IRQ_I2C:
 524                     ; 157         Value = (uint8_t)(ITC->ISPR5 & Mask); /* Read software priority */
 526  0049 c67f74        	ld	a,32628
 527                     ; 158         break;
 529  004c 2008          	jp	LC001
 530  004e               L35:
 531                     ; 173     case ITC_IRQ_ADC1:
 531                     ; 174 #endif /*STM8S105, STM8S103 or STM8S905 or STM8AF626x */
 531                     ; 175 
 531                     ; 176 #ifdef STM8S903
 531                     ; 177     case ITC_IRQ_TIM6_OVFTRI:
 531                     ; 178 #else
 531                     ; 179     case ITC_IRQ_TIM4_OVF:
 531                     ; 180 #endif /*STM8S903*/
 531                     ; 181         Value = (uint8_t)(ITC->ISPR6 & Mask); /* Read software priority */
 533  004e c67f75        	ld	a,32629
 534                     ; 182         break;
 536  0051 2003          	jp	LC001
 537  0053               L55:
 538                     ; 183     case ITC_IRQ_EEPROM_EEC:
 538                     ; 184         Value = (uint8_t)(ITC->ISPR7 & Mask); /* Read software priority */
 ...
 546                     ; 187         break;
 548  005a               L502:
 549                     ; 190     Value >>= (uint8_t)(((uint8_t)IrqNum % 4u) * 2u);
 ...
 563  006a               L43:
 564                     ; 192     return((ITC_PriorityLevel_TypeDef)Value);
 ...
 662                     ; 209 void ITC_SetSoftwarePriority(ITC_Irq_TypeDef IrqNum, ITC_PriorityLevel_TypeDef PriorityValue)
 662                     ; 210 {
 ...
 671                     ; 212     uint8_t Mask = 0;
 673                     ; 213     uint8_t NewPriority = 0;
 675                     ; 216     assert_param(IS_ITC_IRQ_OK((uint8_t)IrqNum));
 677  0002 9e            	ld	a,xh
 678  0003 a119          	cp	a,#25
 679  0005 2506          	jrult	L44
 680  0007 ae00d8        	ldw	x,#216
 681  000a cd00e5        	call	LC002
 682  000d               L44:
 683                     ; 217     assert_param(IS_ITC_PRIORITY_OK(PriorityValue));
 ...
 694  001e ae00d9        	ldw	x,#217
 695  0021 cd00e5        	call	LC002
 696  0024               L45:
 697                     ; 220     assert_param(IS_ITC_INTERRUPTS_DISABLED);
 699  0024 cd0000        	call	_ITC_GetSoftIntStatus
 701  0027 a128          	cp	a,#40
 702  0029 2706          	jreq	L46
 703  002b ae00dc        	ldw	x,#220
 704  002e cd00e5        	call	LC002
 705  0031               L46:
 706                     ; 224     Mask = (uint8_t)(~(uint8_t)(0x03U << (((uint8_t)IrqNum % 4U) * 2U)));
 ...
 723                     ; 227     NewPriority = (uint8_t)((uint8_t)(PriorityValue) << (((uint8_t)IrqNum % 4U) * 2U));
 ...
 750  0065 fc            	jp	(x)
 751  0066               L702:
 752                     ; 232     case ITC_IRQ_TLI: /* TLI software priority can be written but has no meaning */
 752                     ; 233     case ITC_IRQ_AWU:
 752                     ; 234     case ITC_IRQ_CLK:
 752                     ; 235     case ITC_IRQ_PORTA:
 752                     ; 236         ITC->ISPR1 &= Mask;
 754  0066 c67f70        	ld	a,32624
 755  0069 1401          	and	a,(OFST-1,sp)
 756  006b c77f70        	ld	32624,a
 757                     ; 237         ITC->ISPR1 |= NewPriority;
 ...
 765  0078               L112:
 766                     ; 240     case ITC_IRQ_PORTB:
 766                     ; 241     case ITC_IRQ_PORTC:
 766                     ; 242     case ITC_IRQ_PORTD:
 766                     ; 243     case ITC_IRQ_PORTE:
 766                     ; 244         ITC->ISPR2 &= Mask;
 768  0078 c67f71        	ld	a,32625
 769  007b 1401          	and	a,(OFST-1,sp)
 770  007d c77f71        	ld	32625,a
 771                     ; 245         ITC->ISPR2 |= NewPriority;
 ...
 779  008a               L312:
 780                     ; 256     case ITC_IRQ_SPI:
 780                     ; 257     case ITC_IRQ_TIM1_OVF:
 780                     ; 258         ITC->ISPR3 &= Mask;
 782  008a c67f72        	ld	a,32626
 783  008d 1401          	and	a,(OFST-1,sp)
 784  008f c77f72        	ld	32626,a
 785                     ; 259         ITC->ISPR3 |= NewPriority;
 ...
 793  009c               L512:
 794                     ; 262     case ITC_IRQ_TIM1_CAPCOM:
 794                     ; 263 #ifdef STM8S903
 794                     ; 264     case ITC_IRQ_TIM5_OVFTRI:
 794                     ; 265     case ITC_IRQ_TIM5_CAPCOM:
 794                     ; 266 #else
 794                     ; 267     case ITC_IRQ_TIM2_OVF:
 794                     ; 268     case ITC_IRQ_TIM2_CAPCOM:
 794                     ; 269 #endif /*STM8S903*/
 794                     ; 270 
 794                     ; 271     case ITC_IRQ_TIM3_OVF:
 794                     ; 272         ITC->ISPR4 &= Mask;
 796  009c c67f73        	ld	a,32627
 797  009f 1401          	and	a,(OFST-1,sp)
 798  00a1 c77f73        	ld	32627,a
 799                     ; 273         ITC->ISPR4 |= NewPriority;
 ...
 807  00ae               L712:
 808                     ; 276     case ITC_IRQ_TIM3_CAPCOM:
 808                     ; 277     case ITC_IRQ_UART1_TX:
 808                     ; 278     case ITC_IRQ_UART1_RX:
 808                     ; 279     case ITC_IRQ_I2C:
 808                     ; 280         ITC->ISPR5 &= Mask;
 810  00ae c67f74        	ld	a,32628
 811  00b1 1401          	and	a,(OFST-1,sp)
 812  00b3 c77f74        	ld	32628,a
 813                     ; 281         ITC->ISPR5 |= NewPriority;
 ...
 821  00c0               L122:
 822                     ; 298     case ITC_IRQ_ADC1:
 822                     ; 299 #endif /*STM8S105, STM8S103 or STM8S905 or STM8AF626x */
 822                     ; 300 
 822                     ; 301 #ifdef STM8S903
 822                     ; 302     case ITC_IRQ_TIM6_OVFTRI:
 822                     ; 303 #else
 822                     ; 304     case ITC_IRQ_TIM4_OVF:
 822                     ; 305 #endif /*STM8S903*/
 822                     ; 306         ITC->ISPR6 &= Mask;
 824  00c0 c67f75        	ld	a,32629
 825  00c3 1401          	and	a,(OFST-1,sp)
 826  00c5 c77f75        	ld	32629,a
 827                     ; 307         ITC->ISPR6 |= NewPriority;
 ...
 835  00d2               L322:
 836                     ; 310     case ITC_IRQ_EEPROM_EEC:
 836                     ; 311         ITC->ISPR7 &= Mask;
 838  00d2 c67f76        	ld	a,32630
 839  00d5 1401          	and	a,(OFST-1,sp)
 840  00d7 c77f76        	ld	32630,a
 841                     ; 312         ITC->ISPR7 |= NewPriority;
