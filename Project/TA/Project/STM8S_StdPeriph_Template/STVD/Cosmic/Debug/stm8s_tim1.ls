  ...
  49                     ; 52 void TIM1_DeInit(void)
  49                     ; 53 {
  51                     .text:	section	.text,new
  52  0000               _TIM1_DeInit:
  56                     ; 54     TIM1->CR1  = TIM1_CR1_RESET_VALUE;
  58  0000 725f5250      	clr	21072
  59                     ; 55     TIM1->CR2  = TIM1_CR2_RESET_VALUE;
  61  0004 725f5251      	clr	21073
  62                     ; 56     TIM1->SMCR = TIM1_SMCR_RESET_VALUE;
  64  0008 725f5252      	clr	21074
  65                     ; 57     TIM1->ETR  = TIM1_ETR_RESET_VALUE;
  67  000c 725f5253      	clr	21075
  68                     ; 58     TIM1->IER  = TIM1_IER_RESET_VALUE;
  70  0010 725f5254      	clr	21076
  71                     ; 59     TIM1->SR2  = TIM1_SR2_RESET_VALUE;
  73  0014 725f5256      	clr	21078
  74                     ; 61     TIM1->CCER1 = TIM1_CCER1_RESET_VALUE;
  76  0018 725f525c      	clr	21084
  77                     ; 62     TIM1->CCER2 = TIM1_CCER2_RESET_VALUE;
  79  001c 725f525d      	clr	21085
  80                     ; 64     TIM1->CCMR1 = 0x01;
  82  0020 35015258      	mov	21080,#1
  83                     ; 65     TIM1->CCMR2 = 0x01;
  85  0024 35015259      	mov	21081,#1
  86                     ; 66     TIM1->CCMR3 = 0x01;
  88  0028 3501525a      	mov	21082,#1
  89                     ; 67     TIM1->CCMR4 = 0x01;
  91  002c 3501525b      	mov	21083,#1
  92                     ; 69     TIM1->CCER1 = TIM1_CCER1_RESET_VALUE;
  94  0030 725f525c      	clr	21084
  95                     ; 70     TIM1->CCER2 = TIM1_CCER2_RESET_VALUE;
  97  0034 725f525d      	clr	21085
  98                     ; 71     TIM1->CCMR1 = TIM1_CCMR1_RESET_VALUE;
 100  0038 725f5258      	clr	21080
 101                     ; 72     TIM1->CCMR2 = TIM1_CCMR2_RESET_VALUE;
 103  003c 725f5259      	clr	21081
 104                     ; 73     TIM1->CCMR3 = TIM1_CCMR3_RESET_VALUE;
 106  0040 725f525a      	clr	21082
 107                     ; 74     TIM1->CCMR4 = TIM1_CCMR4_RESET_VALUE;
 109  0044 725f525b      	clr	21083
 110                     ; 75     TIM1->CNTRH = TIM1_CNTRH_RESET_VALUE;
 112  0048 725f525e      	clr	21086
 113                     ; 76     TIM1->CNTRL = TIM1_CNTRL_RESET_VALUE;
 115  004c 725f525f      	clr	21087
 116                     ; 77     TIM1->PSCRH = TIM1_PSCRH_RESET_VALUE;
 118  0050 725f5260      	clr	21088
 119                     ; 78     TIM1->PSCRL = TIM1_PSCRL_RESET_VALUE;
 121  0054 725f5261      	clr	21089
 122                     ; 79     TIM1->ARRH  = TIM1_ARRH_RESET_VALUE;
 124  0058 35ff5262      	mov	21090,#255
 125                     ; 80     TIM1->ARRL  = TIM1_ARRL_RESET_VALUE;
 127  005c 35ff5263      	mov	21091,#255
 128                     ; 81     TIM1->CCR1H = TIM1_CCR1H_RESET_VALUE;
 130  0060 725f5265      	clr	21093
 131                     ; 82     TIM1->CCR1L = TIM1_CCR1L_RESET_VALUE;
 133  0064 725f5266      	clr	21094
 134                     ; 83     TIM1->CCR2H = TIM1_CCR2H_RESET_VALUE;
 136  0068 725f5267      	clr	21095
 137                     ; 84     TIM1->CCR2L = TIM1_CCR2L_RESET_VALUE;
 139  006c 725f5268      	clr	21096
 140                     ; 85     TIM1->CCR3H = TIM1_CCR3H_RESET_VALUE;
 142  0070 725f5269      	clr	21097
 143                     ; 86     TIM1->CCR3L = TIM1_CCR3L_RESET_VALUE;
 145  0074 725f526a      	clr	21098
 146                     ; 87     TIM1->CCR4H = TIM1_CCR4H_RESET_VALUE;
 148  0078 725f526b      	clr	21099
 149                     ; 88     TIM1->CCR4L = TIM1_CCR4L_RESET_VALUE;
 151  007c 725f526c      	clr	21100
 152                     ; 89     TIM1->OISR  = TIM1_OISR_RESET_VALUE;
 154  0080 725f526f      	clr	21103
 155                     ; 90     TIM1->EGR   = 0x01; /* TIM1_EGR_UG */
 157  0084 35015257      	mov	21079,#1
 158                     ; 91     TIM1->DTR   = TIM1_DTR_RESET_VALUE;
 160  0088 725f526e      	clr	21102
 161                     ; 92     TIM1->BKR   = TIM1_BKR_RESET_VALUE;
 163  008c 725f526d      	clr	21101
 164                     ; 93     TIM1->RCR   = TIM1_RCR_RESET_VALUE;
 166  0090 725f5264      	clr	21092
 167                     ; 94     TIM1->SR1   = TIM1_SR1_RESET_VALUE;
 ...
 311  0023               L41:
 312                     ; 115     TIM1->ARRH = (uint8_t)(TIM1_Period >> 8);
 314  0023 7b06          	ld	a,(OFST+6,sp)
 315  0025 c75262        	ld	21090,a
 316                     ; 116     TIM1->ARRL = (uint8_t)(TIM1_Period);
 318  0028 7b07          	ld	a,(OFST+7,sp)
 319  002a c75263        	ld	21091,a
 320                     ; 119     TIM1->PSCRH = (uint8_t)(TIM1_Prescaler >> 8);
 322  002d 7b01          	ld	a,(OFST+1,sp)
 323  002f c75260        	ld	21088,a
 324                     ; 120     TIM1->PSCRL = (uint8_t)(TIM1_Prescaler);
 326  0032 7b02          	ld	a,(OFST+2,sp)
 327  0034 c75261        	ld	21089,a
 328                     ; 123     TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)(~(TIM1_CR1_CMS | TIM1_CR1_DIR)))
 328                     ; 124                            | (uint8_t)(TIM1_CounterMode));
 330  0037 c65250        	ld	a,21072
 331  003a a48f          	and	a,#143
 332  003c 1a05          	or	a,(OFST+5,sp)
 333  003e c75250        	ld	21072,a
 334                     ; 127     TIM1->RCR = TIM1_RepetitionCounter;
 336  0041 7b08          	ld	a,(OFST+8,sp)
 337  0043 c75264        	ld	21092,a
 338                     ; 129 }
 341  0046 85            	popw	x
 342  0047 81            	ret	
 628                     ; 150 void TIM1_OC1Init(TIM1_OCMode_TypeDef TIM1_OCMode,
 628                     ; 151                   TIM1_OutputState_TypeDef TIM1_OutputState,
 628                     ; 152                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
 628                     ; 153                   uint16_t TIM1_Pulse,
 628                     ; 154                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
 628                     ; 155                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
 628                     ; 156                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
 628                     ; 157                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
 628                     ; 158 {
 ...
 637                     ; 160     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
 639  0003 9e            	ld	a,xh
 640  0004 4d            	tnz	a
 ...
 703  0067 ae00a5        	ldw	x,#165
 704  006a ad6a          	call	LC001
 705  006c               L67:
 706                     ; 166     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
 ...
 713  0076 ae00a6        	ldw	x,#166
 714  0079 ad5b          	call	LC001
 715  007b               L601:
 716                     ; 170     TIM1->CCER1 &= (uint8_t)(~( TIM1_CCER1_CC1E | TIM1_CCER1_CC1NE 
 716                     ; 171                                | TIM1_CCER1_CC1P | TIM1_CCER1_CC1NP));
 718  007b c6525c        	ld	a,21084
 719  007e a4f0          	and	a,#240
 720  0080 c7525c        	ld	21084,a
 721                     ; 174   TIM1->CCER1 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC1E)
 721                     ; 175                                      | (uint8_t)(TIM1_OutputNState & TIM1_CCER1_CC1NE))
 721                     ; 176                            | (uint8_t)( (uint8_t)(TIM1_OCPolarity  & TIM1_CCER1_CC1P)
 721                     ; 177                                         | (uint8_t)(TIM1_OCNPolarity & TIM1_CCER1_CC1NP)));
 ...
 739                     ; 180     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) | 
 739                     ; 181                             (uint8_t)TIM1_OCMode);
 741  00a5 c65258        	ld	a,21080
 742  00a8 a48f          	and	a,#143
 743  00aa 1a04          	or	a,(OFST+1,sp)
 744  00ac c75258        	ld	21080,a
 745                     ; 184     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS1 | TIM1_OISR_OIS1N));
 747  00af c6526f        	ld	a,21103
 748  00b2 a4fc          	and	a,#252
 749  00b4 c7526f        	ld	21103,a
 750                     ; 186     TIM1->OISR |= (uint8_t)((uint8_t)( TIM1_OCIdleState & TIM1_OISR_OIS1 ) | 
 750                     ; 187                             (uint8_t)( TIM1_OCNIdleState & TIM1_OISR_OIS1N ));
 ...
 760                     ; 190     TIM1->CCR1H = (uint8_t)(TIM1_Pulse >> 8);
 762  00c9 7b09          	ld	a,(OFST+6,sp)
 763  00cb c75265        	ld	21093,a
 764                     ; 191     TIM1->CCR1L = (uint8_t)(TIM1_Pulse);
 ...
 781  00e1 81            	ret	
 886                     ; 213 void TIM1_OC2Init(TIM1_OCMode_TypeDef TIM1_OCMode,
 886                     ; 214                   TIM1_OutputState_TypeDef TIM1_OutputState,
 886                     ; 215                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
 886                     ; 216                   uint16_t TIM1_Pulse,
 886                     ; 217                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
 886                     ; 218                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
 886                     ; 219                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
 886                     ; 220                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
 886                     ; 221 {
 ...
 895                     ; 223     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
 897  0003 9e            	ld	a,xh
 898  0004 4d            	tnz	a
 ...
 961  0067 ae00e4        	ldw	x,#228
 962  006a ad6a          	call	LC002
 963  006c               L071:
 964                     ; 229     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
 ...
 971  0076 ae00e5        	ldw	x,#229
 972  0079 ad5b          	call	LC002
 973  007b               L002:
 974                     ; 233     TIM1->CCER1 &= (uint8_t)(~( TIM1_CCER1_CC2E | TIM1_CCER1_CC2NE | 
 974                     ; 234                                 TIM1_CCER1_CC2P | TIM1_CCER1_CC2NP));
 976  007b c6525c        	ld	a,21084
 977  007e a40f          	and	a,#15
 978  0080 c7525c        	ld	21084,a
 979                     ; 238     TIM1->CCER1 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER1_CC2E  ) | 
 979                     ; 239                              (uint8_t)(TIM1_OutputNState & TIM1_CCER1_CC2NE )) | 
 979                     ; 240                              (uint8_t)((uint8_t)(TIM1_OCPolarity  & TIM1_CCER1_CC2P  ) | 
 979                     ; 241                              (uint8_t)(TIM1_OCNPolarity & TIM1_CCER1_CC2NP )));
 ...
 997                     ; 244     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM)) | 
 997                     ; 245                              (uint8_t)TIM1_OCMode);
 999  00a5 c65259        	ld	a,21081
1000  00a8 a48f          	and	a,#143
1001  00aa 1a04          	or	a,(OFST+1,sp)
1002  00ac c75259        	ld	21081,a
1003                     ; 248     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS2 | TIM1_OISR_OIS2N));
1005  00af c6526f        	ld	a,21103
1006  00b2 a4f3          	and	a,#243
1007  00b4 c7526f        	ld	21103,a
1008                     ; 250     TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS2 & TIM1_OCIdleState) | 
1008                     ; 251                             (uint8_t)(TIM1_OISR_OIS2N & TIM1_OCNIdleState));
...
1018                     ; 254     TIM1->CCR2H = (uint8_t)(TIM1_Pulse >> 8);
1020  00c9 7b09          	ld	a,(OFST+6,sp)
1021  00cb c75267        	ld	21095,a
1022                     ; 255     TIM1->CCR2L = (uint8_t)(TIM1_Pulse);
...
1039  00e1 81            	ret	
1144                     ; 278 void TIM1_OC3Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1144                     ; 279                   TIM1_OutputState_TypeDef TIM1_OutputState,
1144                     ; 280                   TIM1_OutputNState_TypeDef TIM1_OutputNState,
1144                     ; 281                   uint16_t TIM1_Pulse,
1144                     ; 282                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1144                     ; 283                   TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity,
1144                     ; 284                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState,
1144                     ; 285                   TIM1_OCNIdleState_TypeDef TIM1_OCNIdleState)
1144                     ; 286 {
...
1153                     ; 288     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
...
1219  0067 ae0125        	ldw	x,#293
1220  006a ad6a          	call	LC003
1221  006c               L262:
1222                     ; 294     assert_param(IS_TIM1_OCNIDLE_STATE_OK(TIM1_OCNIdleState));
...
1229  0076 ae0126        	ldw	x,#294
1230  0079 ad5b          	call	LC003
1231  007b               L272:
1232                     ; 298     TIM1->CCER2 &= (uint8_t)(~( TIM1_CCER2_CC3E | TIM1_CCER2_CC3NE | 
1232                     ; 299                                 TIM1_CCER2_CC3P | TIM1_CCER2_CC3NP));
1234  007b c6525d        	ld	a,21085
1235  007e a4f0          	and	a,#240
1236  0080 c7525d        	ld	21085,a
1237                     ; 302     TIM1->CCER2 |= (uint8_t)((uint8_t)((uint8_t)(TIM1_OutputState  & TIM1_CCER2_CC3E   ) |
1237                     ; 303                              (uint8_t)(TIM1_OutputNState & TIM1_CCER2_CC3NE  )) | 
1237                     ; 304                              (uint8_t)((uint8_t)(TIM1_OCPolarity   & TIM1_CCER2_CC3P   ) | 
1237                     ; 305                              (uint8_t)(TIM1_OCNPolarity  & TIM1_CCER2_CC3NP  )));
...
1255                     ; 308     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) | 
1255                     ; 309                              (uint8_t)TIM1_OCMode);
1257  00a5 c6525a        	ld	a,21082
1258  00a8 a48f          	and	a,#143
1259  00aa 1a04          	or	a,(OFST+1,sp)
1260  00ac c7525a        	ld	21082,a
1261                     ; 312     TIM1->OISR &= (uint8_t)(~(TIM1_OISR_OIS3 | TIM1_OISR_OIS3N));
1263  00af c6526f        	ld	a,21103
1264  00b2 a4cf          	and	a,#207
1265  00b4 c7526f        	ld	21103,a
1266                     ; 314     TIM1->OISR |= (uint8_t)((uint8_t)(TIM1_OISR_OIS3 & TIM1_OCIdleState) | 
1266                     ; 315                             (uint8_t)(TIM1_OISR_OIS3N & TIM1_OCNIdleState));
...
1276                     ; 318     TIM1->CCR3H = (uint8_t)(TIM1_Pulse >> 8);
1278  00c9 7b09          	ld	a,(OFST+6,sp)
1279  00cb c75269        	ld	21097,a
1280                     ; 319     TIM1->CCR3L = (uint8_t)(TIM1_Pulse);
...
1297  00e1 81            	ret	
1372                     ; 336 void TIM1_OC4Init(TIM1_OCMode_TypeDef TIM1_OCMode,
1372                     ; 337                   TIM1_OutputState_TypeDef TIM1_OutputState,
1372                     ; 338                   uint16_t TIM1_Pulse,
1372                     ; 339                   TIM1_OCPolarity_TypeDef TIM1_OCPolarity,
1372                     ; 340                   TIM1_OCIdleState_TypeDef TIM1_OCIdleState)
1372                     ; 341 {
...
1381                     ; 343     assert_param(IS_TIM1_OC_MODE_OK(TIM1_OCMode));
...
1429  0048 ae015a        	ldw	x,#346
1430  004b ad43          	call	LC004
1431  004d               L433:
1432                     ; 349     TIM1->CCER2 &= (uint8_t)(~(TIM1_CCER2_CC4E | TIM1_CCER2_CC4P));
1434  004d c6525d        	ld	a,21085
1435  0050 a4cf          	and	a,#207
1436  0052 c7525d        	ld	21085,a
1437                     ; 351     TIM1->CCER2 |= (uint8_t)((uint8_t)(TIM1_OutputState & TIM1_CCER2_CC4E ) |  
1437                     ; 352                              (uint8_t)(TIM1_OCPolarity  & TIM1_CCER2_CC4P ));
...
1490  009b 81            	ret	
1696                     ; 387 void TIM1_BDTRConfig(TIM1_OSSIState_TypeDef TIM1_OSSIState,
1696                     ; 388                      TIM1_LockLevel_TypeDef TIM1_LockLevel,
1696                     ; 389                      uint8_t TIM1_DeadTime,
1696                     ; 390                      TIM1_BreakState_TypeDef TIM1_Break,
1696                     ; 391                      TIM1_BreakPolarity_TypeDef TIM1_BreakPolarity,
1696                     ; 392                      TIM1_AutomaticOutput_TypeDef TIM1_AutomaticOutput)
1696                     ; 393 {
...
1705                     ; 395     assert_param(IS_TIM1_OSSI_STATE_OK(TIM1_OSSIState));
...
1713  000b ae018b        	ldw	x,#395
1714  000e ad59          	call	LC005
1715  0010               L643:
1716                     ; 396     assert_param(IS_TIM1_LOCK_LEVEL_OK(TIM1_LockLevel));
...
1726  0020 ae018c        	ldw	x,#396
1727  0023 ad44          	call	LC005
1728  0025               L653:
1729                     ; 397     assert_param(IS_TIM1_BREAK_STATE_OK(TIM1_Break));
...
1736  002f ae018d        	ldw	x,#397
1737  0032 ad35          	call	LC005
1738  0034               L663:
1739                     ; 398     assert_param(IS_TIM1_BREAK_POLARITY_OK(TIM1_BreakPolarity));
1741  0034 7b08          	ld	a,(OFST+7,sp)
1742  0036 2709          	jreq	L673
1743  0038 a120          	cp	a,#32
1744  003a 2705          	jreq	L673
1745  003c ae018e        	ldw	x,#398
1746  003f ad28          	call	LC005
1747  0041               L673:
1748                     ; 399     assert_param(IS_TIM1_AUTOMATIC_OUTPUT_STATE_OK(TIM1_AutomaticOutput));
...
1755  004b ae018f        	ldw	x,#399
1756  004e ad19          	call	LC005
1757  0050               L604:
1758                     ; 401     TIM1->DTR = (uint8_t)(TIM1_DeadTime);
1760  0050 7b06          	ld	a,(OFST+5,sp)
1761  0052 c7526e        	ld	21102,a
1762                     ; 405     TIM1->BKR  =  (uint8_t)((uint8_t)(TIM1_OSSIState | (uint8_t)TIM1_LockLevel)  | 
1762                     ; 406                             (uint8_t)((uint8_t)(TIM1_Break | (uint8_t)TIM1_BreakPolarity)  | 
1762                     ; 407                             (uint8_t)TIM1_AutomaticOutput));
...
1996                     ; 431     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
...
2010  0013 ae01af        	ldw	x,#431
2011  0016 cd00b5        	call	LC006
2012  0019               L024:
2013                     ; 432     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
2015  0019 7b02          	ld	a,(OFST+2,sp)
2016  001b 2709          	jreq	L034
2017  001d 4a            	dec	a
2018  001e 2706          	jreq	L034
2019  0020 ae01b0        	ldw	x,#432
2020  0023 cd00b5        	call	LC006
2021  0026               L034:
2022                     ; 433     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
...
2031  0034 ae01b1        	ldw	x,#433
2032  0037 ad7c          	call	LC006
2033  0039               L044:
2034                     ; 434     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
...
2044  0049 ae01b2        	ldw	x,#434
2045  004c ad67          	call	LC006
2046  004e               L054:
2047                     ; 435     assert_param(IS_TIM1_IC_FILTER_OK(TIM1_ICFilter));
2049  004e 7b07          	ld	a,(OFST+7,sp)
2050  0050 a110          	cp	a,#16
2051  0052 2505          	jrult	L654
2052  0054 ae01b3        	ldw	x,#435
2053  0057 ad5c          	call	LC006
2054  0059               L654:
2055                     ; 437     if (TIM1_Channel == TIM1_CHANNEL_1)
2057  0059 7b01          	ld	a,(OFST+1,sp)
2058  005b 2614          	jrne	L176
2059                     ; 440         TI1_Config((uint8_t)TIM1_ICPolarity,
2059                     ; 441                    (uint8_t)TIM1_ICSelection,
2059                     ; 442                    (uint8_t)TIM1_ICFilter);
...
2069  0069 84            	pop	a
2070                     ; 444         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
2072  006a 7b06          	ld	a,(OFST+6,sp)
2073  006c cd0000        	call	_TIM1_SetIC1Prescaler
2076  006f 2042          	jra	L376
2077  0071               L176:
2078                     ; 446     else if (TIM1_Channel == TIM1_CHANNEL_2)
2080  0071 a101          	cp	a,#1
2081  0073 2614          	jrne	L576
2082                     ; 449         TI2_Config((uint8_t)TIM1_ICPolarity,
2082                     ; 450                    (uint8_t)TIM1_ICSelection,
2082                     ; 451                    (uint8_t)TIM1_ICFilter);
...
2092  0081 84            	pop	a
2093                     ; 453         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2095  0082 7b06          	ld	a,(OFST+6,sp)
2096  0084 cd0000        	call	_TIM1_SetIC2Prescaler
2099  0087 202a          	jra	L376
2100  0089               L576:
2101                     ; 455     else if (TIM1_Channel == TIM1_CHANNEL_3)
2103  0089 a102          	cp	a,#2
2104  008b 2614          	jrne	L107
2105                     ; 458         TI3_Config((uint8_t)TIM1_ICPolarity,
2105                     ; 459                    (uint8_t)TIM1_ICSelection,
2105                     ; 460                    (uint8_t)TIM1_ICFilter);
...
2115  0099 84            	pop	a
2116                     ; 462         TIM1_SetIC3Prescaler(TIM1_ICPrescaler);
2118  009a 7b06          	ld	a,(OFST+6,sp)
2119  009c cd0000        	call	_TIM1_SetIC3Prescaler
2122  009f 2012          	jra	L376
2123  00a1               L107:
2124                     ; 467         TI4_Config((uint8_t)TIM1_ICPolarity,
2124                     ; 468                    (uint8_t)TIM1_ICSelection,
2124                     ; 469                    (uint8_t)TIM1_ICFilter);
...
2134  00ad 84            	pop	a
2135                     ; 471         TIM1_SetIC4Prescaler(TIM1_ICPrescaler);
...
2154  00c0 81            	ret	
2251                     ; 490 void TIM1_PWMIConfig(TIM1_Channel_TypeDef TIM1_Channel,
2251                     ; 491                      TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
2251                     ; 492                      TIM1_ICSelection_TypeDef TIM1_ICSelection,
2251                     ; 493                      TIM1_ICPSC_TypeDef TIM1_ICPrescaler,
2251                     ; 494                      uint8_t TIM1_ICFilter)
2251                     ; 495 {
...
2260                     ; 496     uint8_t icpolarity = TIM1_ICPOLARITY_RISING;
2262                     ; 497     uint8_t icselection = TIM1_ICSELECTION_DIRECTTI;
2264                     ; 500     assert_param(IS_TIM1_PWMI_CHANNEL_OK(TIM1_Channel));
...
2272  000a ae01f4        	ldw	x,#500
2273  000d cd00ac        	call	LC007
2274  0010               L015:
2275                     ; 501     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
2277  0010 7b04          	ld	a,(OFST+2,sp)
2278  0012 2709          	jreq	L025
2279  0014 4a            	dec	a
2280  0015 2706          	jreq	L025
2281  0017 ae01f5        	ldw	x,#501
2282  001a cd00ac        	call	LC007
2283  001d               L025:
2284                     ; 502     assert_param(IS_TIM1_IC_SELECTION_OK(TIM1_ICSelection));
...
2293  002b ae01f6        	ldw	x,#502
2294  002e ad7c          	call	LC007
2295  0030               L035:
2296                     ; 503     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_ICPrescaler));
...
2306  0040 ae01f7        	ldw	x,#503
2307  0043 ad67          	call	LC007
2308  0045               L045:
2309                     ; 506     if (TIM1_ICPolarity != TIM1_ICPOLARITY_FALLING)
2311  0045 7b04          	ld	a,(OFST+2,sp)
2312  0047 4a            	dec	a
2313  0048 2702          	jreq	L357
2314                     ; 508         icpolarity = TIM1_ICPOLARITY_FALLING;
2316  004a a601          	ld	a,#1
2318  004c               L357:
2319                     ; 512         icpolarity = TIM1_ICPOLARITY_RISING;
2321  004c 6b01          	ld	(OFST-1,sp),a
2322                     ; 516     if (TIM1_ICSelection == TIM1_ICSELECTION_DIRECTTI)
2324  004e 7b07          	ld	a,(OFST+5,sp)
2325  0050 4a            	dec	a
2326  0051 2604          	jrne	L757
2327                     ; 518         icselection = TIM1_ICSELECTION_INDIRECTTI;
2329  0053 a602          	ld	a,#2
2331  0055 2002          	jra	L167
2332  0057               L757:
2333                     ; 522         icselection = TIM1_ICSELECTION_DIRECTTI;
2335  0057 a601          	ld	a,#1
2336  0059               L167:
2337  0059 6b02          	ld	(OFST+0,sp),a
2338                     ; 525     if (TIM1_Channel == TIM1_CHANNEL_1)
2340  005b 7b03          	ld	a,(OFST+1,sp)
2341  005d 2626          	jrne	L367
2342                     ; 528         TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
2342                     ; 529                    (uint8_t)TIM1_ICFilter);
...
2352  006b 84            	pop	a
2353                     ; 532         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
2355  006c 7b08          	ld	a,(OFST+6,sp)
2356  006e cd0000        	call	_TIM1_SetIC1Prescaler
2358                     ; 535         TI2_Config(icpolarity, icselection, TIM1_ICFilter);
...
2368  007d 84            	pop	a
2369                     ; 538         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2371  007e 7b08          	ld	a,(OFST+6,sp)
2372  0080 cd0000        	call	_TIM1_SetIC2Prescaler
2375  0083 2024          	jra	L567
2376  0085               L367:
2377                     ; 543         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
2377                     ; 544                    (uint8_t)TIM1_ICFilter);
...
2387  0091 84            	pop	a
2388                     ; 547         TIM1_SetIC2Prescaler(TIM1_ICPrescaler);
2390  0092 7b08          	ld	a,(OFST+6,sp)
2391  0094 cd0000        	call	_TIM1_SetIC2Prescaler
2393                     ; 550         TI1_Config(icpolarity, icselection, TIM1_ICFilter);
...
2403  00a3 84            	pop	a
2404                     ; 553         TIM1_SetIC1Prescaler(TIM1_ICPrescaler);
...
2423  00b7 81            	ret	
2479                     ; 563 void TIM1_Cmd(FunctionalState NewState)
2479                     ; 564 {
2480                     .text:	section	.text,new
2481  0000               _TIM1_Cmd:
2483  0000 88            	push	a
2484       00000000      OFST:	set	0
2487                     ; 566     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2489  0001 4d            	tnz	a
2490  0002 2711          	jreq	L275
2491  0004 4a            	dec	a
2492  0005 270e          	jreq	L275
2493  0007 ae0236        	ldw	x,#566
...
2762  0037 81            	ret	
2786                     ; 642 void TIM1_InternalClockConfig(void)
2786                     ; 643 {
2787                     .text:	section	.text,new
2788  0000               _TIM1_InternalClockConfig:
2792                     ; 645     TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_SMS);
2794  0000 c65252        	ld	a,21074
2795  0003 a4f8          	and	a,#248
2796  0005 c75252        	ld	21074,a
2797                     ; 646 }
2800  0008 81            	ret	
2918                     ; 664 void TIM1_ETRClockMode1Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
2918                     ; 665                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
2918                     ; 666                               uint8_t ExtTRGFilter)
2918                     ; 667 {
2919                     .text:	section	.text,new
2920  0000               _TIM1_ETRClockMode1Config:
2922  0000 89            	pushw	x
2923       00000000      OFST:	set	0
2926                     ; 669     assert_param(IS_TIM1_EXT_PRESCALER_OK(TIM1_ExtTRGPrescaler));
...
2940  0014 ae029d        	ldw	x,#669
2941  0017 ad26          	call	LC009
2942  0019               L046:
2943                     ; 670     assert_param(IS_TIM1_EXT_POLARITY_OK(TIM1_ExtTRGPolarity));
...
2950  0023 ae029e        	ldw	x,#670
2951  0026 ad17          	call	LC009
2952  0028               L056:
2953                     ; 673     TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
2963  0034 84            	pop	a
2964                     ; 676     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~(uint8_t)(TIM1_SMCR_SMS | TIM1_SMCR_TS )))
2964                     ; 677                            | (uint8_t)((uint8_t)TIM1_SLAVEMODE_EXTERNAL1 | TIM1_TS_ETRF ));
...
2982  004a 81            	ret	
3041                     ; 696 void TIM1_ETRClockMode2Config(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3041                     ; 697                               TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3041                     ; 698                               uint8_t ExtTRGFilter)
3041                     ; 699 {
3042                     .text:	section	.text,new
3043  0000               _TIM1_ETRClockMode2Config:
3045  0000 89            	pushw	x
3046       00000000      OFST:	set	0
3049                     ; 701     assert_param(IS_TIM1_EXT_PRESCALER_OK(TIM1_ExtTRGPrescaler));
...
3063  0014 ae02bd        	ldw	x,#701
3064  0017 ad22          	call	LC010
3065  0019               L466:
3066                     ; 702     assert_param(IS_TIM1_EXT_POLARITY_OK(TIM1_ExtTRGPolarity));
...
3073  0023 ae02be        	ldw	x,#702
3074  0026 ad13          	call	LC010
3075  0028               L476:
3076                     ; 705     TIM1_ETRConfig(TIM1_ExtTRGPrescaler, TIM1_ExtTRGPolarity, ExtTRGFilter);
...
3087  0038 84            	pop	a
3088                     ; 708     TIM1->ETR |= TIM1_ETR_ECE;
3090                     ; 709 }
3093  0039 85            	popw	x
3094  003a 81            	ret	
3095  003b               LC010:
...
3103  0046 81            	ret	
3160                     ; 727 void TIM1_ETRConfig(TIM1_ExtTRGPSC_TypeDef TIM1_ExtTRGPrescaler,
3160                     ; 728                     TIM1_ExtTRGPolarity_TypeDef TIM1_ExtTRGPolarity,
3160                     ; 729                     uint8_t ExtTRGFilter)
3160                     ; 730 {
3161                     .text:	section	.text,new
3162  0000               _TIM1_ETRConfig:
3164  0000 89            	pushw	x
3165       00000000      OFST:	set	0
3168                     ; 732     assert_param(IS_TIM1_EXT_TRG_FILTER_OK(ExtTRGFilter));
3170  0001 7b05          	ld	a,(OFST+5,sp)
3171  0003 a110          	cp	a,#16
3172  0005 250e          	jrult	L607
3173  0007 ae02dc        	ldw	x,#732
...
3181  0015               L607:
3182                     ; 734     TIM1->ETR |= (uint8_t)((uint8_t)(TIM1_ExtTRGPrescaler | (uint8_t)TIM1_ExtTRGPolarity )|
3182                     ; 735                       (uint8_t)ExtTRGFilter );
...
3192  0021 85            	popw	x
3193  0022 81            	ret	
3283                     ; 753 void TIM1_TIxExternalClockConfig(TIM1_TIxExternalCLK1Source_TypeDef TIM1_TIxExternalCLKSource,
3283                     ; 754                                  TIM1_ICPolarity_TypeDef TIM1_ICPolarity,
3283                     ; 755                                  uint8_t ICFilter)
3283                     ; 756 {
3284                     .text:	section	.text,new
3285  0000               _TIM1_TIxExternalClockConfig:
3287  0000 89            	pushw	x
3288       00000000      OFST:	set	0
3291                     ; 758     assert_param(IS_TIM1_TIXCLK_SOURCE_OK(TIM1_TIxExternalCLKSource));
...
3302  0010 ae02f6        	ldw	x,#758
3303  0013 ad47          	call	LC011
3304  0015               L027:
3305                     ; 759     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_ICPolarity));
3307  0015 7b02          	ld	a,(OFST+2,sp)
3308  0017 2708          	jreq	L037
3309  0019 4a            	dec	a
3310  001a 2705          	jreq	L037
3311  001c ae02f7        	ldw	x,#759
3312  001f ad3b          	call	LC011
3313  0021               L037:
3314                     ; 760     assert_param(IS_TIM1_IC_FILTER_OK(ICFilter));
3316  0021 7b05          	ld	a,(OFST+5,sp)
3317  0023 a110          	cp	a,#16
3318  0025 2505          	jrult	L637
3319  0027 ae02f8        	ldw	x,#760
3320  002a ad30          	call	LC011
3321  002c               L637:
3322                     ; 763     if (TIM1_TIxExternalCLKSource == TIM1_TIXEXTERNALCLK1SOURCE_TI2)
3324  002c 7b01          	ld	a,(OFST+1,sp)
3325  002e a160          	cp	a,#96
3326  0030 260e          	jrne	L3131
3327                     ; 765         TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
3338  0040               L3131:
3339                     ; 769         TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
...
3348  004c               L5131:
3349  004c 84            	pop	a
3350                     ; 773     TIM1_SelectInputTrigger((TIM1_TS_TypeDef)TIM1_TIxExternalCLKSource);
3352  004d 7b01          	ld	a,(OFST+1,sp)
3353  004f cd0000        	call	_TIM1_SelectInputTrigger
3355                     ; 776     TIM1->SMCR |= (uint8_t)(TIM1_SLAVEMODE_EXTERNAL1);
...
3373  0067 81            	ret	
3459                     ; 789 void TIM1_SelectInputTrigger(TIM1_TS_TypeDef TIM1_InputTriggerSource)
3459                     ; 790 {
3460                     .text:	section	.text,new
3461  0000               _TIM1_SelectInputTrigger:
3463  0000 88            	push	a
3464       00000000      OFST:	set	0
3467                     ; 792     assert_param(IS_TIM1_TRIGGER_SELECTION_OK(TIM1_InputTriggerSource));
...
3489  0026               L657:
3490                     ; 795     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_TS)) | (uint8_t)TIM1_InputTriggerSource);
...
3499  0030 84            	pop	a
3500  0031 81            	ret	
3537                     ; 806 void TIM1_UpdateDisableConfig(FunctionalState NewState)
3537                     ; 807 {
3538                     .text:	section	.text,new
3539  0000               _TIM1_UpdateDisableConfig:
3541  0000 88            	push	a
3542       00000000      OFST:	set	0
3545                     ; 809     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
3547  0001 4d            	tnz	a
3548  0002 2711          	jreq	L077
3549  0004 4a            	dec	a
3550  0005 270e          	jreq	L077
3551  0007 ae0329        	ldw	x,#809
...
3836  0016               L6201:
3837                     ; 884     if (TIM1_OPMode != TIM1_OPMODE_REPETITIVE)
3839  0016 7b01          	ld	a,(OFST+1,sp)
3840  0018 2706          	jreq	L1051
3841                     ; 886         TIM1->CR1 |= TIM1_CR1_OPM;
3843  001a 72165250      	bset	21072,#3
3845  001e 2004          	jra	L3051
3846  0020               L1051:
3847                     ; 890         TIM1->CR1 &= (uint8_t)(~TIM1_CR1_OPM);
3849  0020 72175250      	bres	21072,#3
3850  0024               L3051:
3851                     ; 893 }
3854  0024 84            	pop	a
3855  0025 81            	ret	
3954                     ; 909 void TIM1_SelectOutputTrigger(TIM1_TRGOSource_TypeDef TIM1_TRGOSource)
3954                     ; 910 {
3955                     .text:	section	.text,new
3956  0000               _TIM1_SelectOutputTrigger:
3958  0000 88            	push	a
3959       00000000      OFST:	set	0
3962                     ; 912     assert_param(IS_TIM1_TRGO_SOURCE_OK(TIM1_TRGOSource));
3964  0001 4d            	tnz	a
...
3986  002a               L0401:
3987                     ; 915     TIM1->CR2 = (uint8_t)((uint8_t)(TIM1->CR2 & (uint8_t)(~TIM1_CR2_MMS)) | 
3987                     ; 916                           (uint8_t) TIM1_TRGOSource);
...
3996  0034 84            	pop	a
3997  0035 81            	ret	
4072                     ; 929 void TIM1_SelectSlaveMode(TIM1_SlaveMode_TypeDef TIM1_SlaveMode)
4072                     ; 930 {
4073                     .text:	section	.text,new
4074  0000               _TIM1_SelectSlaveMode:
4076  0000 88            	push	a
4077       00000000      OFST:	set	0
4080                     ; 933     assert_param(IS_TIM1_SLAVE_MODE_OK(TIM1_SlaveMode));
...
4098  001f               L2501:
4099                     ; 936     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~TIM1_SMCR_SMS)) |
4099                     ; 937                            (uint8_t)TIM1_SlaveMode);
...
4108  0029 84            	pop	a
4109  002a 81            	ret	
4146                     ; 947 void TIM1_SelectMasterSlaveMode(FunctionalState NewState)
4146                     ; 948 {
4147                     .text:	section	.text,new
4148  0000               _TIM1_SelectMasterSlaveMode:
4150  0000 88            	push	a
4151       00000000      OFST:	set	0
4154                     ; 950     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4156  0001 4d            	tnz	a
4157  0002 2711          	jreq	L4601
4158  0004 4a            	dec	a
4159  0005 270e          	jreq	L4601
4160  0007 ae03b6        	ldw	x,#950
...
4168  0015               L4601:
4169                     ; 953     if (NewState != DISABLE)
4171  0015 7b01          	ld	a,(OFST+1,sp)
4172  0017 2706          	jreq	L5161
4173                     ; 955         TIM1->SMCR |= TIM1_SMCR_MSM;
4175  0019 721e5252      	bset	21074,#7
4177  001d 2004          	jra	L7161
4178  001f               L5161:
4179                     ; 959         TIM1->SMCR &= (uint8_t)(~TIM1_SMCR_MSM);
4181  001f 721f5252      	bres	21074,#7
4182  0023               L7161:
4183                     ; 961 }
4186  0023 84            	pop	a
4187  0024 81            	ret	
4274                     ; 983 void TIM1_EncoderInterfaceConfig(TIM1_EncoderMode_TypeDef TIM1_EncoderMode,
4274                     ; 984                                  TIM1_ICPolarity_TypeDef TIM1_IC1Polarity,
4274                     ; 985                                  TIM1_ICPolarity_TypeDef TIM1_IC2Polarity)
4274                     ; 986 {
4275                     .text:	section	.text,new
4276  0000               _TIM1_EncoderInterfaceConfig:
4278  0000 89            	pushw	x
4279       00000000      OFST:	set	0
4282                     ; 990     assert_param(IS_TIM1_ENCODER_MODE_OK(TIM1_EncoderMode));
...
4293  000f ae03de        	ldw	x,#990
4294  0012 ad54          	call	LC012
4295  0014               L6701:
4296                     ; 991     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC1Polarity));
4298  0014 7b02          	ld	a,(OFST+2,sp)
4299  0016 2708          	jreq	L6011
4300  0018 4a            	dec	a
4301  0019 2705          	jreq	L6011
4302  001b ae03df        	ldw	x,#991
4303  001e ad48          	call	LC012
4304  0020               L6011:
4305                     ; 992     assert_param(IS_TIM1_IC_POLARITY_OK(TIM1_IC2Polarity));
4307  0020 7b05          	ld	a,(OFST+5,sp)
4308  0022 2708          	jreq	L6111
4309  0024 4a            	dec	a
4310  0025 2705          	jreq	L6111
4311  0027 ae03e0        	ldw	x,#992
4312  002a ad3c          	call	LC012
4313  002c               L6111:
4314                     ; 995     if (TIM1_IC1Polarity != TIM1_ICPOLARITY_RISING)
4316  002c 7b02          	ld	a,(OFST+2,sp)
4317  002e 2706          	jreq	L1661
4318                     ; 997         TIM1->CCER1 |= TIM1_CCER1_CC1P;
4320  0030 7212525c      	bset	21084,#1
4322  0034 2004          	jra	L3661
4323  0036               L1661:
4324                     ; 1001         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
4326  0036 7213525c      	bres	21084,#1
4327  003a               L3661:
4328                     ; 1004     if (TIM1_IC2Polarity != TIM1_ICPOLARITY_RISING)
4330  003a 7b05          	ld	a,(OFST+5,sp)
4331  003c 2706          	jreq	L5661
4332                     ; 1006         TIM1->CCER1 |= TIM1_CCER1_CC2P;
4334  003e 721a525c      	bset	21084,#5
4336  0042 2004          	jra	L7661
4337  0044               L5661:
4338                     ; 1010         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
4340  0044 721b525c      	bres	21084,#5
4341  0048               L7661:
4342                     ; 1013     TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(TIM1_SMCR_MSM | TIM1_SMCR_TS))
4342                     ; 1014                            | (uint8_t) TIM1_EncoderMode);
4344  0048 c65252        	ld	a,21074
4345  004b a4f0          	and	a,#240
4346  004d 1a01          	or	a,(OFST+1,sp)
4347  004f c75252        	ld	21074,a
4348                     ; 1017     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_CCxS)) 
4348                     ; 1018                             | (uint8_t) CCMR_TIxDirect_Set);
4350  0052 c65258        	ld	a,21080
4351  0055 a4fc          	and	a,#252
4352  0057 aa01          	or	a,#1
4353  0059 c75258        	ld	21080,a
4354                     ; 1019     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_CCxS))
4354                     ; 1020                             | (uint8_t) CCMR_TIxDirect_Set);
...
4373  0073 81            	ret	
4441                     ; 1035 void TIM1_PrescalerConfig(uint16_t Prescaler,
4441                     ; 1036                           TIM1_PSCReloadMode_TypeDef TIM1_PSCReloadMode)
4441                     ; 1037 {
4442                     .text:	section	.text,new
4443  0000               _TIM1_PrescalerConfig:
4445  0000 89            	pushw	x
4446       00000000      OFST:	set	0
4449                     ; 1039     assert_param(IS_TIM1_PRESCALER_RELOAD_OK(TIM1_PSCReloadMode));
4451  0001 7b05          	ld	a,(OFST+5,sp)
4452  0003 2711          	jreq	L0311
4453  0005 4a            	dec	a
4454  0006 270e          	jreq	L0311
4455  0008 ae040f        	ldw	x,#1039
...
4463  0016               L0311:
4464                     ; 1042     TIM1->PSCRH = (uint8_t)(Prescaler >> 8);
4466  0016 7b01          	ld	a,(OFST+1,sp)
4467  0018 c75260        	ld	21088,a
4468                     ; 1043     TIM1->PSCRL = (uint8_t)(Prescaler);
4470  001b 7b02          	ld	a,(OFST+2,sp)
4471  001d c75261        	ld	21089,a
4472                     ; 1046     TIM1->EGR = (uint8_t)TIM1_PSCReloadMode;
4474  0020 7b05          	ld	a,(OFST+5,sp)
4475  0022 c75257        	ld	21079,a
4476                     ; 1048 }
4479  0025 85            	popw	x
4480  0026 81            	ret	
4517                     ; 1061 void TIM1_CounterModeConfig(TIM1_CounterMode_TypeDef TIM1_CounterMode)
4517                     ; 1062 {
4518                     .text:	section	.text,new
4519  0000               _TIM1_CounterModeConfig:
4521  0000 88            	push	a
4522       00000000      OFST:	set	0
4525                     ; 1064     assert_param(IS_TIM1_COUNTER_MODE_OK(TIM1_CounterMode));
4527  0001 4d            	tnz	a
...
4545  0022               L2411:
4546                     ; 1068     TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)((uint8_t)(~TIM1_CR1_CMS) & (uint8_t)(~TIM1_CR1_DIR)))
4546                     ; 1069                           | (uint8_t)TIM1_CounterMode);
...
4637  0017               L4511:
4638                     ; 1087     TIM1->CCMR1 =  (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM))|
4638                     ; 1088                              (uint8_t)TIM1_ForcedAction);
...
4707  0017               L6611:
4708                     ; 1106     TIM1->CCMR2  =  (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
4708                     ; 1107                               | (uint8_t)TIM1_ForcedAction);
...
4777  0017               L0021:
4778                     ; 1126     TIM1->CCMR3  =  (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM))  
4778                     ; 1127                               | (uint8_t)TIM1_ForcedAction);
...
4847  0017               L2121:
4848                     ; 1146     TIM1->CCMR4  =  (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
4848                     ; 1147                               | (uint8_t)TIM1_ForcedAction);
...
4857  0021 84            	pop	a
4858  0022 81            	ret	
4895                     ; 1157 void TIM1_ARRPreloadConfig(FunctionalState NewState)
4895                     ; 1158 {
4896                     .text:	section	.text,new
4897  0000               _TIM1_ARRPreloadConfig:
4899  0000 88            	push	a
4900       00000000      OFST:	set	0
4903                     ; 1160     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
4905  0001 4d            	tnz	a
4906  0002 2711          	jreq	L4221
4907  0004 4a            	dec	a
4908  0005 270e          	jreq	L4221
4909  0007 ae0488        	ldw	x,#1160
...
5692  0015               L0731:
5693                     ; 1393     if (NewState != DISABLE)
5695  0015 7b01          	ld	a,(OFST+1,sp)
5696  0017 2706          	jreq	L3432
5697                     ; 1395         TIM1->CCMR4 |= TIM1_CCMR_OCxFE;
5699  0019 7214525b      	bset	21083,#2
5701  001d 2004          	jra	L5432
5702  001f               L3432:
5703                     ; 1399         TIM1->CCMR4 &= (uint8_t)(~TIM1_CCMR_OCxFE);
5705  001f 7215525b      	bres	21083,#2
5706  0023               L5432:
5707                     ; 1401 }
5710  0023 84            	pop	a
5711  0024 81            	ret	
5817                     ; 1418 void TIM1_GenerateEvent(TIM1_EventSource_TypeDef TIM1_EventSource)
5817                     ; 1419 {
5818                     .text:	section	.text,new
5819  0000               _TIM1_GenerateEvent:
5821  0000 88            	push	a
5822       00000000      OFST:	set	0
5825                     ; 1421     assert_param(IS_TIM1_EVENT_SOURCE_OK(TIM1_EventSource));
5827  0001 4d            	tnz	a
5828  0002 260e          	jrne	L0041
5829  0004 ae058d        	ldw	x,#1421
...
5905  0016               L2141:
5906                     ; 1442     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
5908  0016 7b01          	ld	a,(OFST+1,sp)
5909  0018 2706          	jreq	L7242
5910                     ; 1444         TIM1->CCER1 |= TIM1_CCER1_CC1P;
5912  001a 7212525c      	bset	21084,#1
5914  001e 2004          	jra	L1342
5915  0020               L7242:
5916                     ; 1448         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
5918  0020 7213525c      	bres	21084,#1
5919  0024               L1342:
5920                     ; 1450 }
5923  0024 84            	pop	a
5924  0025 81            	ret	
5961                     ; 1461 void TIM1_OC1NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
5961                     ; 1462 {
5962                     .text:	section	.text,new
5963  0000               _TIM1_OC1NPolarityConfig:
5965  0000 88            	push	a
5966       00000000      OFST:	set	0
5969                     ; 1464     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
5971  0001 4d            	tnz	a
5972  0002 2712          	jreq	L4241
5973  0004 a188          	cp	a,#136
5974  0006 270e          	jreq	L4241
5975  0008 ae05b8        	ldw	x,#1464
...
5983  0016               L4241:
5984                     ; 1467     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
5986  0016 7b01          	ld	a,(OFST+1,sp)
5987  0018 2706          	jreq	L1542
5988                     ; 1469         TIM1->CCER1 |= TIM1_CCER1_CC1NP;
5990  001a 7216525c      	bset	21084,#3
5992  001e 2004          	jra	L3542
5993  0020               L1542:
5994                     ; 1473         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1NP);
5996  0020 7217525c      	bres	21084,#3
5997  0024               L3542:
5998                     ; 1475 }
6001  0024 84            	pop	a
6002  0025 81            	ret	
6039                     ; 1486 void TIM1_OC2PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6039                     ; 1487 {
6040                     .text:	section	.text,new
6041  0000               _TIM1_OC2PolarityConfig:
6043  0000 88            	push	a
6044       00000000      OFST:	set	0
6047                     ; 1489     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6049  0001 4d            	tnz	a
6050  0002 2712          	jreq	L6341
6051  0004 a122          	cp	a,#34
6052  0006 270e          	jreq	L6341
6053  0008 ae05d1        	ldw	x,#1489
...
6061  0016               L6341:
6062                     ; 1492     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6064  0016 7b01          	ld	a,(OFST+1,sp)
6065  0018 2706          	jreq	L3742
6066                     ; 1494         TIM1->CCER1 |= TIM1_CCER1_CC2P;
6068  001a 721a525c      	bset	21084,#5
6070  001e 2004          	jra	L5742
6071  0020               L3742:
6072                     ; 1498         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
6074  0020 721b525c      	bres	21084,#5
6075  0024               L5742:
6076                     ; 1500 }
6079  0024 84            	pop	a
6080  0025 81            	ret	
6117                     ; 1510 void TIM1_OC2NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6117                     ; 1511 {
6118                     .text:	section	.text,new
6119  0000               _TIM1_OC2NPolarityConfig:
6121  0000 88            	push	a
6122       00000000      OFST:	set	0
6125                     ; 1513     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6127  0001 4d            	tnz	a
6128  0002 2712          	jreq	L0541
6129  0004 a188          	cp	a,#136
6130  0006 270e          	jreq	L0541
6131  0008 ae05e9        	ldw	x,#1513
...
6139  0016               L0541:
6140                     ; 1516     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6142  0016 7b01          	ld	a,(OFST+1,sp)
6143  0018 2706          	jreq	L5152
6144                     ; 1518         TIM1->CCER1 |= TIM1_CCER1_CC2NP;
6146  001a 721e525c      	bset	21084,#7
6148  001e 2004          	jra	L7152
6149  0020               L5152:
6150                     ; 1522         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2NP);
6152  0020 721f525c      	bres	21084,#7
6153  0024               L7152:
6154                     ; 1524 }
6157  0024 84            	pop	a
6158  0025 81            	ret	
6195                     ; 1535 void TIM1_OC3PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6195                     ; 1536 {
6196                     .text:	section	.text,new
6197  0000               _TIM1_OC3PolarityConfig:
6199  0000 88            	push	a
6200       00000000      OFST:	set	0
6203                     ; 1538     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6205  0001 4d            	tnz	a
6206  0002 2712          	jreq	L2641
6207  0004 a122          	cp	a,#34
6208  0006 270e          	jreq	L2641
6209  0008 ae0602        	ldw	x,#1538
...
6217  0016               L2641:
6218                     ; 1541     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6220  0016 7b01          	ld	a,(OFST+1,sp)
6221  0018 2706          	jreq	L7352
6222                     ; 1543         TIM1->CCER2 |= TIM1_CCER2_CC3P;
6224  001a 7212525d      	bset	21085,#1
6226  001e 2004          	jra	L1452
6227  0020               L7352:
6228                     ; 1547         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
6230  0020 7213525d      	bres	21085,#1
6231  0024               L1452:
6232                     ; 1549 }
6235  0024 84            	pop	a
6236  0025 81            	ret	
6273                     ; 1560 void TIM1_OC3NPolarityConfig(TIM1_OCNPolarity_TypeDef TIM1_OCNPolarity)
6273                     ; 1561 {
6274                     .text:	section	.text,new
6275  0000               _TIM1_OC3NPolarityConfig:
6277  0000 88            	push	a
6278       00000000      OFST:	set	0
6281                     ; 1563     assert_param(IS_TIM1_OCN_POLARITY_OK(TIM1_OCNPolarity));
6283  0001 4d            	tnz	a
6284  0002 2712          	jreq	L4741
6285  0004 a188          	cp	a,#136
6286  0006 270e          	jreq	L4741
6287  0008 ae061b        	ldw	x,#1563
...
6295  0016               L4741:
6296                     ; 1566     if (TIM1_OCNPolarity != TIM1_OCNPOLARITY_HIGH)
6298  0016 7b01          	ld	a,(OFST+1,sp)
6299  0018 2706          	jreq	L1652
6300                     ; 1568         TIM1->CCER2 |= TIM1_CCER2_CC3NP;
6302  001a 7216525d      	bset	21085,#3
6304  001e 2004          	jra	L3652
6305  0020               L1652:
6306                     ; 1572         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3NP);
6308  0020 7217525d      	bres	21085,#3
6309  0024               L3652:
6310                     ; 1574 }
6313  0024 84            	pop	a
6314  0025 81            	ret	
6351                     ; 1584 void TIM1_OC4PolarityConfig(TIM1_OCPolarity_TypeDef TIM1_OCPolarity)
6351                     ; 1585 {
6352                     .text:	section	.text,new
6353  0000               _TIM1_OC4PolarityConfig:
6355  0000 88            	push	a
6356       00000000      OFST:	set	0
6359                     ; 1587     assert_param(IS_TIM1_OC_POLARITY_OK(TIM1_OCPolarity));
6361  0001 4d            	tnz	a
6362  0002 2712          	jreq	L6051
6363  0004 a122          	cp	a,#34
6364  0006 270e          	jreq	L6051
6365  0008 ae0633        	ldw	x,#1587
...
6373  0016               L6051:
6374                     ; 1590     if (TIM1_OCPolarity != TIM1_OCPOLARITY_HIGH)
6376  0016 7b01          	ld	a,(OFST+1,sp)
6377  0018 2706          	jreq	L3062
6378                     ; 1592         TIM1->CCER2 |= TIM1_CCER2_CC4P;
6380  001a 721a525d      	bset	21085,#5
6382  001e 2004          	jra	L5062
6383  0020               L3062:
6384                     ; 1596         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
6386  0020 721b525d      	bres	21085,#5
6387  0024               L5062:
6388                     ; 1598 }
6391  0024 84            	pop	a
6392  0025 81            	ret	
6438                     ; 1613 void TIM1_CCxCmd(TIM1_Channel_TypeDef TIM1_Channel, FunctionalState NewState)
6438                     ; 1614 {
6439                     .text:	section	.text,new
6440  0000               _TIM1_CCxCmd:
6442  0000 89            	pushw	x
6443       00000000      OFST:	set	0
6446                     ; 1616     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
...
6556  007b 81            	ret	
6602                     ; 1681 void TIM1_CCxNCmd(TIM1_Channel_TypeDef TIM1_Channel, FunctionalState NewState)
6602                     ; 1682 {
6603                     .text:	section	.text,new
6604  0000               _TIM1_CCxNCmd:
6606  0000 89            	pushw	x
6607       00000000      OFST:	set	0
6610                     ; 1684     assert_param(IS_TIM1_COMPLEMENTARY_CHANNEL_OK(TIM1_Channel));
...
6698  0061 81            	ret	
6744                     ; 1747 void TIM1_SelectOCxM(TIM1_Channel_TypeDef TIM1_Channel, TIM1_OCMode_TypeDef TIM1_OCMode)
6744                     ; 1748 {
6745                     .text:	section	.text,new
6746  0000               _TIM1_SelectOCxM:
6748  0000 89            	pushw	x
6749       00000000      OFST:	set	0
6752                     ; 1750     assert_param(IS_TIM1_CHANNEL_OK(TIM1_Channel));
...
6766  0013 ae06d6        	ldw	x,#1750
6767  0016 ad71          	call	LC015
6768  0018               L4651:
6769                     ; 1751     assert_param(IS_TIM1_OCM_OK(TIM1_OCMode));
...
6787  0038 ae06d7        	ldw	x,#1751
6788  003b ad4c          	call	LC015
6789  003d               L4751:
6790                     ; 1753     if (TIM1_Channel == TIM1_CHANNEL_1)
6792  003d 7b01          	ld	a,(OFST+1,sp)
6793  003f 2610          	jrne	L5572
6794                     ; 1756         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
6796  0041 7211525c      	bres	21084,#0
6797                     ; 1759         TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_OCM)) 
6797                     ; 1760                                 | (uint8_t)TIM1_OCMode);
...
6805  0051               L5572:
6806                     ; 1762     else if (TIM1_Channel == TIM1_CHANNEL_2)
6808  0051 a101          	cp	a,#1
6809  0053 2610          	jrne	L1672
6810                     ; 1765         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2E);
6812  0055 7219525c      	bres	21084,#4
6813                     ; 1768         TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_OCM))
6813                     ; 1769                                 | (uint8_t)TIM1_OCMode);
...
6821  0065               L1672:
6822                     ; 1771     else if (TIM1_Channel == TIM1_CHANNEL_3)
6824  0065 a102          	cp	a,#2
6825  0067 2610          	jrne	L5672
6826                     ; 1774         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3E);
6828  0069 7211525d      	bres	21085,#0
6829                     ; 1777         TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_OCM)) 
6829                     ; 1778                                 | (uint8_t)TIM1_OCMode);
...
6837  0079               L5672:
6838                     ; 1783         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4E);
6840  0079 7219525d      	bres	21085,#4
6841                     ; 1786         TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) 
6841                     ; 1787                                 | (uint8_t)TIM1_OCMode);
...
7230  001e               L2261:
7231                     ; 1898     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~TIM1_CCMR_ICxPSC)) 
7231                     ; 1899                             | (uint8_t)TIM1_IC1Prescaler);
...
7240  0028 84            	pop	a
7241  0029 81            	ret	
7278                     ; 1913 void TIM1_SetIC2Prescaler(TIM1_ICPSC_TypeDef TIM1_IC2Prescaler)
7278                     ; 1914 {
7279                     .text:	section	.text,new
7280  0000               _TIM1_SetIC2Prescaler:
7282  0000 88            	push	a
7283       00000000      OFST:	set	0
7286                     ; 1917     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC2Prescaler));
7288  0001 4d            	tnz	a
...
7304  001e               L4361:
7305                     ; 1920     TIM1->CCMR2 = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~TIM1_CCMR_ICxPSC))
7305                     ; 1921                             | (uint8_t)TIM1_IC2Prescaler);
...
7314  0028 84            	pop	a
7315  0029 81            	ret	
7352                     ; 1935 void TIM1_SetIC3Prescaler(TIM1_ICPSC_TypeDef TIM1_IC3Prescaler)
7352                     ; 1936 {
7353                     .text:	section	.text,new
7354  0000               _TIM1_SetIC3Prescaler:
7356  0000 88            	push	a
7357       00000000      OFST:	set	0
7360                     ; 1939     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC3Prescaler));
7362  0001 4d            	tnz	a
...
7378  001e               L6461:
7379                     ; 1942     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~TIM1_CCMR_ICxPSC)) | 
7379                     ; 1943                             (uint8_t)TIM1_IC3Prescaler);
...
7388  0028 84            	pop	a
7389  0029 81            	ret	
7426                     ; 1956 void TIM1_SetIC4Prescaler(TIM1_ICPSC_TypeDef TIM1_IC4Prescaler)
7426                     ; 1957 {
7427                     .text:	section	.text,new
7428  0000               _TIM1_SetIC4Prescaler:
7430  0000 88            	push	a
7431       00000000      OFST:	set	0
7434                     ; 1960     assert_param(IS_TIM1_IC_PRESCALER_OK(TIM1_IC4Prescaler));
7436  0001 4d            	tnz	a
...
7452  001e               L0661:
7453                     ; 1963     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_ICxPSC)) |
7453                     ; 1964                             (uint8_t)TIM1_IC4Prescaler);
...
7963  0017 81            	ret	
8138                     ; 2097 FlagStatus TIM1_GetFlagStatus(TIM1_FLAG_TypeDef TIM1_FLAG)
8138                     ; 2098 {
...
8147                     ; 2099     FlagStatus bitstatus = RESET;
8149                     ; 2100     uint8_t tim1_flag_l = 0, tim1_flag_h = 0;
8153                     ; 2103     assert_param(IS_TIM1_GET_FLAG_OK(TIM1_FLAG));
...
8279  001d               L6171:
8280                     ; 2143     TIM1->SR1 = (uint8_t)(~(uint8_t)(TIM1_FLAG));
8282  001d 7b02          	ld	a,(OFST+2,sp)
8283  001f 43            	cpl	a
8284  0020 c75255        	ld	21077,a
8285                     ; 2144     TIM1->SR2 = (uint8_t)((uint8_t)(~((uint8_t)((uint16_t)TIM1_FLAG >> 8))) & 
8285                     ; 2145                           (uint8_t)0x1E);
...
8294  002b 85            	popw	x
8295  002c 81            	ret	
8360                     ; 2162 ITStatus TIM1_GetITStatus(TIM1_IT_TypeDef TIM1_IT)
8360                     ; 2163 {
...
8369                     ; 2164     ITStatus bitstatus = RESET;
8371                     ; 2165     uint8_t TIM1_itStatus = 0, TIM1_itEnable = 0;
8375                     ; 2168     assert_param(IS_TIM1_GET_IT_OK(TIM1_IT));
...
8491  0012               L0471:
8492                     ; 2205     TIM1->SR1 = (uint8_t)(~(uint8_t)TIM1_IT);
...
8500  0018 84            	pop	a
8501  0019 81            	ret	
8553                     ; 2224 static void TI1_Config(uint8_t TIM1_ICPolarity,
8553                     ; 2225                        uint8_t TIM1_ICSelection,
8553                     ; 2226                        uint8_t TIM1_ICFilter)
8553                     ; 2227 {
8554                     .text:	section	.text,new
8555  0000               L3_TI1_Config:
8557  0000 89            	pushw	x
8558       00000001      OFST:	set	1
8561                     ; 2230     TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1E);
8563  0001 7211525c      	bres	21084,#0
8564  0005 88            	push	a
8565                     ; 2233     TIM1->CCMR1 = (uint8_t)((uint8_t)(TIM1->CCMR1 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) | 
8565                     ; 2234                             (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8578                     ; 2237     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
8580  001b 7b02          	ld	a,(OFST+1,sp)
8581  001d 2706          	jreq	L3163
8582                     ; 2239         TIM1->CCER1 |= TIM1_CCER1_CC1P;
8584  001f 7212525c      	bset	21084,#1
8586  0023 2004          	jra	L5163
8587  0025               L3163:
8588                     ; 2243         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC1P);
8590  0025 7213525c      	bres	21084,#1
8591  0029               L5163:
8592                     ; 2247     TIM1->CCER1 |=  TIM1_CCER1_CC1E;
8594  0029 7210525c      	bset	21084,#0
8595                     ; 2248 }
8598  002d 5b03          	addw	sp,#3
8599  002f 81            	ret	
8651                     ; 2266 static void TI2_Config(uint8_t TIM1_ICPolarity,
8651                     ; 2267                        uint8_t TIM1_ICSelection,
8651                     ; 2268                        uint8_t TIM1_ICFilter)
8651                     ; 2269 {
8652                     .text:	section	.text,new
8653  0000               L5_TI2_Config:
8655  0000 89            	pushw	x
8656       00000001      OFST:	set	1
8659                     ; 2271     TIM1->CCER1 &=  (uint8_t)(~TIM1_CCER1_CC2E);
8661  0001 7219525c      	bres	21084,#4
8662  0005 88            	push	a
8663                     ; 2274     TIM1->CCMR2  = (uint8_t)((uint8_t)(TIM1->CCMR2 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF ))) 
8663                     ; 2275                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8676                     ; 2277     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
8678  001b 7b02          	ld	a,(OFST+1,sp)
8679  001d 2706          	jreq	L5463
8680                     ; 2279         TIM1->CCER1 |= TIM1_CCER1_CC2P;
8682  001f 721a525c      	bset	21084,#5
8684  0023 2004          	jra	L7463
8685  0025               L5463:
8686                     ; 2283         TIM1->CCER1 &= (uint8_t)(~TIM1_CCER1_CC2P);
8688  0025 721b525c      	bres	21084,#5
8689  0029               L7463:
8690                     ; 2286     TIM1->CCER1 |=  TIM1_CCER1_CC2E;
8692  0029 7218525c      	bset	21084,#4
8693                     ; 2287 }
8696  002d 5b03          	addw	sp,#3
8697  002f 81            	ret	
8749                     ; 2305 static void TI3_Config(uint8_t TIM1_ICPolarity,
8749                     ; 2306                        uint8_t TIM1_ICSelection,
8749                     ; 2307                        uint8_t TIM1_ICFilter)
8749                     ; 2308 {
8750                     .text:	section	.text,new
8751  0000               L7_TI3_Config:
8753  0000 89            	pushw	x
8754       00000001      OFST:	set	1
8757                     ; 2310     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC3E);
8759  0001 7211525d      	bres	21085,#0
8760  0005 88            	push	a
8761                     ; 2313     TIM1->CCMR3 = (uint8_t)((uint8_t)(TIM1->CCMR3 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF))) 
8761                     ; 2314                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8774                     ; 2317     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
8776  001b 7b02          	ld	a,(OFST+1,sp)
8777  001d 2706          	jreq	L7763
8778                     ; 2319         TIM1->CCER2 |= TIM1_CCER2_CC3P;
8780  001f 7212525d      	bset	21085,#1
8782  0023 2004          	jra	L1073
8783  0025               L7763:
8784                     ; 2323         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC3P);
8786  0025 7213525d      	bres	21085,#1
8787  0029               L1073:
8788                     ; 2326     TIM1->CCER2 |=  TIM1_CCER2_CC3E;
8790  0029 7210525d      	bset	21085,#0
8791                     ; 2327 }
8794  002d 5b03          	addw	sp,#3
8795  002f 81            	ret	
8847                     ; 2346 static void TI4_Config(uint8_t TIM1_ICPolarity,
8847                     ; 2347                        uint8_t TIM1_ICSelection,
8847                     ; 2348                        uint8_t TIM1_ICFilter)
8847                     ; 2349 {
8848                     .text:	section	.text,new
8849  0000               L11_TI4_Config:
8851  0000 89            	pushw	x
8852       00000001      OFST:	set	1
8855                     ; 2352     TIM1->CCER2 &=  (uint8_t)(~TIM1_CCER2_CC4E);
8857  0001 7219525d      	bres	21085,#4
8858  0005 88            	push	a
8859                     ; 2355     TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~(uint8_t)( TIM1_CCMR_CCxS | TIM1_CCMR_ICxF )))
8859                     ; 2356                             | (uint8_t)(( (TIM1_ICSelection)) | ((uint8_t)( TIM1_ICFilter << 4))));
...
8872                     ; 2359     if (TIM1_ICPolarity != TIM1_ICPOLARITY_RISING)
8874  001b 7b02          	ld	a,(OFST+1,sp)
8875  001d 2706          	jreq	L1373
8876                     ; 2361         TIM1->CCER2 |= TIM1_CCER2_CC4P;
8878  001f 721a525d      	bset	21085,#5
8880  0023 2004          	jra	L3373
8881  0025               L1373:
8882                     ; 2365         TIM1->CCER2 &= (uint8_t)(~TIM1_CCER2_CC4P);
8884  0025 721b525d      	bres	21085,#5
8885  0029               L3373:
8886                     ; 2369     TIM1->CCER2 |=  TIM1_CCER2_CC4E;
