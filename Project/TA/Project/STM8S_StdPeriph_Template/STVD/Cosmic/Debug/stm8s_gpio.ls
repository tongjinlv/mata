 ...
 115                     ; 47 void GPIO_DeInit(GPIO_TypeDef* GPIOx)
 115                     ; 48 {
 117                     .text:	section	.text,new
 118  0000               _GPIO_DeInit:
 122                     ; 49     GPIOx->ODR = GPIO_ODR_RESET_VALUE; /* Reset Output Data Register */
 124  0000 7f            	clr	(x)
 125                     ; 50     GPIOx->DDR = GPIO_DDR_RESET_VALUE; /* Reset Data Direction Register */
 127  0001 6f02          	clr	(2,x)
 128                     ; 51     GPIOx->CR1 = GPIO_CR1_RESET_VALUE; /* Reset Control Register 1 */
 130  0003 6f03          	clr	(3,x)
 131                     ; 52     GPIOx->CR2 = GPIO_CR2_RESET_VALUE; /* Reset Control Register 2 */
 ...
 518  009e 81            	ret	
 564                     ; 135 void GPIO_Write(GPIO_TypeDef* GPIOx, uint8_t PortVal)
 564                     ; 136 {
 565                     .text:	section	.text,new
 566  0000               _GPIO_Write:
 568  0000 89            	pushw	x
 569       00000000      OFST:	set	0
 572                     ; 137     GPIOx->ODR = PortVal;
 ...
 580  0006 85            	popw	x
 581  0007 81            	ret	
 628                     ; 148 void GPIO_WriteHigh(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 628                     ; 149 {
 629                     .text:	section	.text,new
 630  0000               _GPIO_WriteHigh:
 632  0000 89            	pushw	x
 633       00000000      OFST:	set	0
 636                     ; 150     GPIOx->ODR |= (uint8_t)PortPins;
 638  0001 f6            	ld	a,(x)
 ...
 700                     ; 163     GPIOx->ODR &= (uint8_t)(~PortPins);
 ...
 709  0006 85            	popw	x
 710  0007 81            	ret	
 757                     ; 174 void GPIO_WriteReverse(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 757                     ; 175 {
 758                     .text:	section	.text,new
 759  0000               _GPIO_WriteReverse:
 761  0000 89            	pushw	x
 762       00000000      OFST:	set	0
 765                     ; 176     GPIOx->ODR ^= (uint8_t)PortPins;
 767  0001 f6            	ld	a,(x)
