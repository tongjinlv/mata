  ...
  92  0014               L01:
  93                     ; 52     WWDG->WR = WWDG_WR_RESET_VALUE;
  95  0014 357f50d2      	mov	20690,#127
  96                     ; 53     WWDG->CR = (uint8_t)((uint8_t)(WWDG_CR_WDGA | WWDG_CR_T6) | (uint8_t)Counter);
  98  0018 7b01          	ld	a,(OFST+1,sp)
  99  001a aac0          	or	a,#192
 100  001c c750d1        	ld	20689,a
 101                     ; 54     WWDG->WR = (uint8_t)((uint8_t)(~WWDG_CR_WDGA) & (uint8_t)(WWDG_CR_T6 | WindowValue));
 ...
 110  0028 85            	popw	x
 111  0029 81            	ret	
 146                     ; 63 void WWDG_SetCounter(uint8_t Counter)
 146                     ; 64 {
 147                     .text:	section	.text,new
 148  0000               _WWDG_SetCounter:
 150  0000 88            	push	a
 151       00000000      OFST:	set	0
 154                     ; 67     assert_param(IS_WWDG_COUNTERVALUE_OK(Counter));
 156  0001 a180          	cp	a,#128
 157  0003 250e          	jrult	L02
 158  0005 ae0043        	ldw	x,#67
 159  0008 89            	pushw	x
 160  0009 5f            	clrw	x
 161  000a 89            	pushw	x
 ...
 301  0013               L43:
 302                     ; 109     WWDG->WR = (uint8_t)((uint8_t)(~WWDG_CR_WDGA) & (uint8_t)(WWDG_CR_T6 | WindowValue));
