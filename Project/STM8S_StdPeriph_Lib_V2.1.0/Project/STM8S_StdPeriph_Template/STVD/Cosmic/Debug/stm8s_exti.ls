  ...
  49                     ; 47 void EXTI_DeInit(void)
  49                     ; 48 {
  51                     .text:	section	.text,new
  52  0000               _EXTI_DeInit:
  56                     ; 49     EXTI->CR1 = EXTI_CR1_RESET_VALUE;
  58  0000 725f50a0      	clr	20640
  59                     ; 50     EXTI->CR2 = EXTI_CR2_RESET_VALUE;
 ...
 216  0018 ae0044        	ldw	x,#68
 217  001b ad7c          	call	LC004
 218  001d               L41:
 219                     ; 69     assert_param(IS_EXTI_SENSITIVITY_OK(SensitivityValue));
 ...
 274  0061               L52:
 275                     ; 82     case EXTI_PORT_GPIOC:
 275                     ; 83         EXTI->CR1 &= (uint8_t)(~EXTI_CR1_PCIS);
 277  0061 c650a0        	ld	a,20640
 278  0064 a4cf          	and	a,#207
 279  0066 c750a0        	ld	20640,a
 280                     ; 84         EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 4);
 ...
 288  0070               L72:
 289                     ; 86     case EXTI_PORT_GPIOD:
 289                     ; 87         EXTI->CR1 &= (uint8_t)(~EXTI_CR1_PDIS);
 291  0070 c650a0        	ld	a,20640
 292  0073 a43f          	and	a,#63
 293  0075 c750a0        	ld	20640,a
 294                     ; 88         EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 6);
 ...
 309  0087               L13:
 310                     ; 90     case EXTI_PORT_GPIOE:
 310                     ; 91         EXTI->CR2 &= (uint8_t)(~EXTI_CR2_PEIS);
 312  0087 c650a1        	ld	a,20641
 313  008a a4fc          	and	a,#252
 314  008c c750a1        	ld	20641,a
 315                     ; 92         EXTI->CR2 |= (uint8_t)(SensitivityValue);
 ...
 338  00a4 81            	ret	
 397                     ; 106 void EXTI_SetTLISensitivity(EXTI_TLISensitivity_TypeDef SensitivityValue)
 397                     ; 107 {
 398                     .text:	section	.text,new
 399  0000               _EXTI_SetTLISensitivity:
 401  0000 88            	push	a
 402       00000000      OFST:	set	0
 405                     ; 109     assert_param(IS_EXTI_TLISENSITIVITY_OK(SensitivityValue));
 407  0001 4d            	tnz	a
 408  0002 2712          	jreq	L63
 409  0004 a104          	cp	a,#4
 410  0006 270e          	jreq	L63
 411  0008 ae006d        	ldw	x,#109
 412  000b 89            	pushw	x
 413  000c 5f            	clrw	x
 414  000d 89            	pushw	x
 ...
 419  0016               L63:
 420                     ; 112     EXTI->CR2 &= (uint8_t)(~EXTI_CR2_TLIS);
 422  0016 721550a1      	bres	20641,#2
 423                     ; 113     EXTI->CR2 |= (uint8_t)(SensitivityValue);
 ...
 431  0022 84            	pop	a
 432  0023 81            	ret	
 479                     ; 121 EXTI_Sensitivity_TypeDef EXTI_GetExtIntSensitivity(EXTI_Port_TypeDef Port)
 479                     ; 122 {
 ...
 573                     ; 145     default:
 573                     ; 146         break;
 575                     ; 149     return((EXTI_Sensitivity_TypeDef)value);
 579  005c 85            	popw	x
 580  005d 81            	ret	
 616                     ; 157 EXTI_TLISensitivity_TypeDef EXTI_GetTLISensitivity(void)
 616                     ; 158 {
 617                     .text:	section	.text,new
 618  0000               _EXTI_GetTLISensitivity:
 620  0000 88            	push	a
 621       00000001      OFST:	set	1
 624                     ; 160     uint8_t value = 0;
 626                     ; 163     value = (uint8_t)(EXTI->CR2 & EXTI_CR2_TLIS);
