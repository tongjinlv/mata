  ...
  85                     ; 42 void IWDG_WriteAccessCmd(IWDG_WriteAccess_TypeDef IWDG_WriteAccess)
  85                     ; 43 {
  87                     .text:	section	.text,new
  88  0000               _IWDG_WriteAccessCmd:
  90  0000 88            	push	a
  91       00000000      OFST:	set	0
  94                     ; 45     assert_param(IS_IWDG_WRITEACCESS_MODE_OK(IWDG_WriteAccess));
  96  0001 a155          	cp	a,#85
  97  0003 2711          	jreq	L21
  98  0005 4d            	tnz	a
  99  0006 270e          	jreq	L21
 100  0008 ae002d        	ldw	x,#45
 101  000b 89            	pushw	x
 102  000c 5f            	clrw	x
 103  000d 89            	pushw	x
 ...
 108  0016               L21:
 109                     ; 47     IWDG->KR = (uint8_t)IWDG_WriteAccess; /* Write Access */
 111  0016 7b01          	ld	a,(OFST+1,sp)
 112  0018 c750e0        	ld	20704,a
 113                     ; 48 }
 116  001b 84            	pop	a
 117  001c 81            	ret	
 208                     ; 57 void IWDG_SetPrescaler(IWDG_Prescaler_TypeDef IWDG_Prescaler)
 208                     ; 58 {
 209                     .text:	section	.text,new
 210  0000               _IWDG_SetPrescaler:
 212  0000 88            	push	a
 213       00000000      OFST:	set	0
 216                     ; 60     assert_param(IS_IWDG_PRESCALER_OK(IWDG_Prescaler));
 218  0001 4d            	tnz	a
 ...
 240  002a               L42:
 241                     ; 62     IWDG->PR = (uint8_t)IWDG_Prescaler;
